...
const TermsOfService = () => {
  ...
  const sections = [
    ...
    { id: "section3", title: "Accuracy of Information" },
    { id: "section4", title: "Modifications to Service" },
    { id: "section5", title: "Products or Services" },
    { id: "section6", title: "Billing Information" },
    { id: "section7", title: "Optional Tools" },
    { id: "section8", title: "Third-Party Links" },
    { id: "section9", title: "User Comments" },
    { id: "section10", title: "Personal Information" },
    { id: "section11", title: "Errors and Omissions" },
    { id: "section12", title: "Prohibited Uses" },
    { id: "section13", title: "Disclaimers" },
    { id: "section14", title: "Indemnification" },
    { id: "section15", title: "Severability" },
    { id: "section16", title: "Termination" },
    { id: "section17", title: "Entire Agreement" },
    { id: "section18", title: "Governing Law" },
    { id: "section19", title: "Changes to Terms" },
              ...
              <div className="p-8 space-y-8">
                ...
                <section id="overview">
                  ...
                  <div className="prose max-w-none text-gray-600">
                    <p>
                      This website is operated by itapelogroup. Throughout the
                      site, the terms "we", "us" and "our" refer to
                      itapelogroup. itapelogroup offers this website, including
                      all information, tools and services available from this
                      site to you, the user, conditioned upon your acceptance of
                ...
                {/* Section 4 - Modifications to Service */}
                <section
                  id="section4"
                  className="pt-8 border-t border-gray-200"
                >
                ...
                >
                  ...
                  <div className="prose max-w-none text-gray-600">
                    ...
                    <p className="mt-4">
                      We are and shall be under no obligation (1) to maintain
                      any comments in confidence; (2) to pay compensation for
                ...
                >
                  ...
                  <div className="prose max-w-none text-gray-600">
                    <p>
                      ...
                      Policy, please see our Privacy Policy page.
                    </p>
                  </div>
                </section>
                ...
                >
                  ...
                  <div className="prose max-w-none text-gray-600">
                    <p>
                      ...
                      itapelogroup and our parent, subsidiaries, affiliates,
