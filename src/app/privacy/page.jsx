          ...
          <div className="p-8 space-y-8">
            ...
            <section>
              <p className="text-gray-600 leading-relaxed">
                We have a 15-day exchange or return policy, which means you have 15
                days after receiving your item to request an exchange or return.
              </p>
              <p className="mt-4 text-gray-600 leading-relaxed">
                To be eligible for an exchange or return, your item must be in the
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                . If your exchange or return is accepted, we'll send you a return
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                Certain types of items cannot be exchanged or returned once opened
                or used, including:
              </p>
              <ul className="mt-4 list-disc list-inside text-gray-600 space-y-2">
                <li>Custom products (such as special orders or personalized items)</li>
                <li>Personal care goods (such as used or open beauty products)</li>
              </ul>
              <p className="mt-4 text-gray-600 leading-relaxed">
            ...
            <section>
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                item you have, and once the return is accepted, then you can make
                an exchange. In situations where the item is damaged, we offer
